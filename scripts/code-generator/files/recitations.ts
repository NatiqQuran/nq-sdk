import * as RecitationsType from "./types/recitations.ts";
...
export class RecitationsController extends BaseController {
    ...
    async update(
        uuid: string, data: RecitationsType.RecitationsUpdateRequestData, config?: RequestConfig
    ...
    async partialUpdate(
        uuid: string, data: RecitationsType.RecitationsPartialupdateRequestData, config?: RequestConfig
