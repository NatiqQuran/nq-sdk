import * as TranslationsType from "./types/translations.ts";
...
export class TranslationsController extends BaseController {
    ...
    async retrieve(
        uuid: string, config?: RequestConfig<TranslationsType.TranslationsRetrieveRequestParams>
    ...
    async update(
        uuid: string, data: TranslationsType.TranslationsUpdateRequestData, config?: RequestConfig
    ...
    async partialUpdate(
        uuid: string, data: TranslationsType.TranslationsPartialupdateRequestData, config?: RequestConfig
    ...
    async translations_ayah_create_2(
        uuid, ayah_uuid: string, data: TranslationsType.TranslationsTranslations_ayah_create_2RequestData, config?: RequestConfig
    ): Promise<AxiosResponse<TranslationsType.TranslationsTranslations_ayah_create_2ResponseData>> {
        return await this.axiosPost(`/translations/${uuid}/ayah/${ayah_uuid}/`, data, config);
    }
    /** PUT /translations/{uuid}/ayah/{ayah_uuid}/ */
    async translations_ayah_update(
        uuid, ayah_uuid: string, data: TranslationsType.TranslationsTranslations_ayah_updateRequestData, config?: RequestConfig
    ): Promise<AxiosResponse<TranslationsType.TranslationsTranslations_ayah_updateResponseData>> {
        return await this.axiosPut(`/translations/${uuid}/ayah/${ayah_uuid}/`, data, config);
    }
    // --- Action methods ---
    ayah() {
