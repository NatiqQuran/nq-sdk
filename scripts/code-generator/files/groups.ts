import * as GroupsType from "./types/groups.ts";
...
export class GroupsController extends BaseController {
    ...
    /** PUT /groups/{id}/ */
    async update(
        id: string, data: GroupsType.GroupsUpdateRequestData, config?: RequestConfig
    ): Promise<AxiosResponse<GroupsType.GroupsUpdateResponseData>> {
        return await this.axiosPut(`/groups/${id}/`, data, config);
    }
    /** PATCH /groups/{id}/ */
    async partialUpdate(
        id: string, data: GroupsType.GroupsPartialupdateRequestData, config?: RequestConfig
